    ...
    <footer id="footer" class="bg-dark pt-5">
        <section id="topFooter">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <img src="" alt="Arı Bilişim Logo" class="w-50">
                        <div class="social my-4">
                            <a href=""><i class="bi bi-facebook"></i></a>
                            <a href=""><i class="bi bi-instagram"></i></a>
                            <a href=""><i class="bi bi-twitter"></i></a>
                            <a href=""><i class="bi bi-linkedin"></i></a>
                            <a href="https://wa.me/+9"><i class="bi bi-whatsapp"></i></a>
                        </div>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <small>Her Hakkı Saklıdır &copy; 2025. Bu web sitesi <a href="https://www.emreakin.com">Emre Akın</a> tarafından hazırlanmıştır</small>
                    </div>
                </div>
            </div>
        </section>
